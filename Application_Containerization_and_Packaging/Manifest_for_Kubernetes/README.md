...
3. Ранее мы разворачивали MetalLB и уже имеем пул external_ip (192.168.0.72-192.168.0.75). Но данный yaml файл всё равно добавлен в каталог, в нашем случаи его можно не использовать.
