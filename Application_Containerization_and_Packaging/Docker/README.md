#Docker
Наши задачи:
1. Написать простое приложение, страничку. Которая будет отдавать простую информацию:
...
- Добавим health check статус. Он нам потребуется для дальнейшего отслеживания метрик нашего приложения через Prometheus.
2. Создать Docke rfile, с нашим приложением.
3. Создать Docker image из нашего Docker file
4. Создание Docker контейнера из нашего Docker image.
5. Пуш Docker image в Docker hub.
